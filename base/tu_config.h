...
// avm2, depending on the lib3ds library
...
// avm2, depending on the libavcode, libavutil & libavformat libraries
...
// avm2, depending on the freetype library
#ifndef TU_CONFIG_LINK_TO_FREETYPE
#define TU_CONFIG_LINK_TO_FREETYPE 0
#endif

// define TU_CONFIG_LINK_TO_THREAD to 0 to switch in avm2 to single thread mode
// define TU_CONFIG_LINK_TO_THREAD to 1 to include SDL thread & mutex support in avm2
...
// define TU_CONFIG_LINK_STATIC to 1 to link avm2 statically 
