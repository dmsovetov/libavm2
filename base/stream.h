// avm2_stream.h	-- Thatcher Ulrich <tu@tulrich.com> 2003
...
#ifndef avm2_STREAM_H
#define avm2_STREAM_H
...
class tu_file;
	...
	struct stream
	{
        ...
        static int readU8( Sint32& result, const Uint8* input );
        static int readU30( Sint32& result, const Uint8* input );
        static int readS24( Sint32& result, const Uint8* input );
