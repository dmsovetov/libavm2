...
inline int	bernstein_hash(const void* data_in, int size, int seed = 5381)
...
inline int	sdbm_hash(const void* data_in, int size, int seed = 5381)
...
inline int	bernstein_hash_case_insensitive(const void* data_in, int size, int seed = 5381)
